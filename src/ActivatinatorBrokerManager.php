...
use Codepunk\Activatinator\Contracts\ActivatinatorBrokerFactory as FactoryContract;
use Illuminate\Support\Str;
use InvalidArgumentException;

class ActivatinatorBrokerManager implements FactoryContract
{
    /**
    ...
    /**
     * Create a new ActivatinatorBroker manager instance.
     *
    ...
    protected function resolve($name)
    {
        ...
        if (is_null($config)) {
            throw new InvalidArgumentException("Activatinator broker [{$name}] is not defined.");
        }

        // The password broker uses a token repository to validate tokens and send user
        // password e-mails, as well as validating that password reset process as an
        // aggregate service of sorts providing a convenient interface for resets.
        return new ActivatinatorBroker(
